...
def add_publications(generator):
    ...
    for formatted_entry in formatted_entries:
        ...
        formatted = {}
        formatted['author'] = plain_style.format_names('author').format_data(entry).render(html_backend)
        formatted['title'] = plain_style.format_title(entry, 'title').format_data(entry).render(html_backend)
        formatted['btitle'] = plain_style.format_btitle(entry, 'booktitle').format_data(entry).render(html_backend)
        formatted['date'] = entry.fields['year']
